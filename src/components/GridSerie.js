...
class GridSerie extends Component {
	...
	componentDidMount() {
		...
		console.log("didMoutGrid");
		console.log(this.props.tipoGrid);
	...
	componentWillReceiveProps(nextProps) {
		console.log("receivedProps grid");
		console.log(nextProps.tipoGrid);
		...
		if(this.state.tipoGrid !== nextProps.tipoGrid){
			this.setState({tipoGrid: nextProps.tipoGrid});
		}
	}
		...
		return (
			<div>
				<div className="botoes">
					<Button className={"info botoes"}> <a id="a" download="ipea.xls" type="text/xls" onClick={() => moduleDownloadExcel(this.props.div)}> Excel </a></Button>
					<Button className={"info botoes"}> <a id="a1" download="ipea.zip" type="text/zip" onClick={() => moduleDownloadZip(this.props.div)}> Zip </a></Button>
					<Button className={"info botoes"}> <a id="a2" download="ipea.csv" type="text/csv" onClick={() => moduleDownloadCSV1(this.props.div)}> CSV(,) </a></Button>
					<Button className={"info botoes"}> <a id="a3" download="ipea.csv" type="text/csv" onClick={() => moduleDownloadCSV2(this.props.div)}>CSV(;) </a></Button>
				</div>
